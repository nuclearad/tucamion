...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { email: @admin_user.email, firstName: @admin_user.firstName, lastName: @admin_user.lastName, status: @admin_user.status }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { email: @admin_user.email, firstName: @admin_user.firstName, lastName: @admin_user.lastName, status: @admin_user.status }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
